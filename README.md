...
## Introduction
This study is a personal project that compares Google’s Machine Translation with DeepL, a German startup claiming to have outdone the silicon valley giant in terms of the accuracy of its translation software.
...
Unit tests in `test/test.py` are run on push with GitHub Actions.
